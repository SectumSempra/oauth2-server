...
public class MfaTokenGranter extends AbstractTokenGranter {
    ...
    public MfaTokenGranter(AuthorizationServerEndpointsConfigurer endpointsConfigurer, AuthenticationManager authenticationManager) {
    ...
    private boolean verifyCode(String username, int code) {
